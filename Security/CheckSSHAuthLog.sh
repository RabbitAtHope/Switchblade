...
sudo cat /var/log/auth.log 2> /dev/null | grep "Accepted password"
...
sudo cat /var/log/auth.log 2> /dev/null | grep "Failed password for" | grep -v "Failed password for invalid user" | grep -v "Failed password for root"
...
sudo cat /var/log/auth.log 2> /dev/null | grep "Failed password for invalid user"
...
sudo cat /var/log/auth.log 2> /dev/null | grep "Failed password for root"
